<footer>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link footernav active" aria-current="page"
                        href="{{ route('tournament.contact') }}">Contact</a>
    ...
    <p id="footer-text">18, Av Omar Ibn Al Khattab Agdal - Rabat | Phone: (+212) 6 21 30 78 78 | Email:
        contact@snookernpool.com <br><br> Copyright © {{ date('Y') }} Snookernpool</p>
