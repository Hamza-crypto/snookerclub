...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/front/css/draw/identity_tournament_table.6ead18d.css') }}" media="all" >
...
<body id="top" class="responsive tennis detailbody detailTableDraw flat pid_2 _fs theme--dark"
      data-new-gr-c-s-check-loaded="14.1080.0" data-gr-ext-installed="" cz-shortcut-listen="true" style="font-family: Arial,sans-serif;">


<div id="detail" class="sport-tennis">
    <div class="header__brand">
        <a class="header__logo logo--mobile snookernpool-com-white" href="#" target="_blank">
            <img src="https://snookernpool.com/assets/front/images/logo.png" alt="Snookernpool" style="padding:8px;">
        </a>
    </div>
    <div id="sportstats">
        <div class="inner">
            ...
            <div id="tournament-table" class="tournament-table-draw">
                <div class="tournamentHeader tournamentHeaderDescription">
                    <div class="tournamentHeader__sportContent "><span class="tournamentHeader__flagIcon"><span
                                class=" flag fl_3473162" title=""></span><i class="fa-solid fa-user"></i></span><span
                            class="tournamentHeader__country">{{ $tournament_title }}</span></div>
                    <div class="dropDown dropDown--tableDraw">
                        <div class="dropDown__selectedValue " tabindex="0">{{ $first_tournament->year->format('Y') }}</div>
                    </div>
                </div>
                <div>
